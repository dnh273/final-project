            ...
            return (
              <tr>
                ...
                <td className="px-6 py-3" key={index}>
                  {
                    filterByNganhHocVaNamHoc(ListNamHoc[4], loai_nguoi_hoc)
                      .length
                  }
                </td>
                <td className="px-6 py-3" key={index}>
                  {
                    filterByNganhHocVaNamHoc(ListNamHoc[3], loai_nguoi_hoc)
                      .length
                  }
                </td>
                <td className="px-6 py-3" key={index}>
                  {
                    filterByNganhHocVaNamHoc(ListNamHoc[2], loai_nguoi_hoc)
                      .length
                  }
                </td>
                <td className="px-6 py-3" key={index}>
                  {
                    filterByNganhHocVaNamHoc(ListNamHoc[1], loai_nguoi_hoc)
                      .length
                  }
                </td>
                <td className="px-6 py-3" key={index}>
                  {
                    filterByNganhHocVaNamHoc(ListNamHoc[0], loai_nguoi_hoc)
                      .length
                  }
                </td>
              </tr>
